...
% clear all;
close all;
num = xlsread('SP_time_s30r40m20f_tcfs.xlsx'); 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
[std(SPslam) std(SPrrt) std(SPmpc) std(SPpath) std(SP) std(100-P(1:length(SPi)))]
...
% figure('Name','Xavier AGX FIFO SLAM 20, rrt 30');
   ...
   figure('Name','individual contr FIFO SLAM 30 RRT 40 MPC 20');
            title('FIFO SLAM 30 RRT 40 MPC 20')
subplot(6,1,1)
