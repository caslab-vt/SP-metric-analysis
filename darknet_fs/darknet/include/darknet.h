...
//struct image;
typedef struct image image_ash;
...
/*LIB_API detection_with_class* test_detector(image im, char *datacfg, char *cfgfile, char *weightfile, float thresh,*/
/*    float hier_thresh, int dont_show, int save_labels, int letter_box, int benchmark_layers);*/
LIB_API masking test_detector_init(int letter_box, int benchmark_layers);
LIB_API detection_with_class* test_detector(masking masking1, image im, float thresh, float hier_thresh, int dont_show, int save_labels, int letter_box, int benchmark_layers);
/*LIB_API void test_detector_multiple_images(char *datacfg, char *cfgfile, char *weightfile, char *folder_name, float thresh,*/
...
//image_opencv.h
LIB_API mat_cv* create_mask_mat(image);
