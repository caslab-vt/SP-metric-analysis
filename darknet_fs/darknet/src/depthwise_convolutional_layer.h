...
#endif
#ifdef GPU
void forward_depthwise_convolutional_layer_gpu(depthwise_convolutional_layer layer, network_state state);
void backward_depthwise_convolutional_layer_gpu(depthwise_convolutional_layer layer, network_state state);
...
void forward_depthwise_convolutional_layer(const depthwise_convolutional_layer layer, network_state state);
...
void backward_depthwise_convolutional_layer(depthwise_convolutional_layer layer, network_state state);
