...
//
	...
	cout << "tracking background impaint" << endl;
...
//
	...
	cout << "tracking geometric model update" << endl;

    mGeometry.GeometricModelUpdateDB(mCurrentFrame);
//

	cout << "tracking end111" << endl;
    imDOut = imDepth;
                                ...
                                const double &timestamp)
{
	...
	cout << "tracking frame definition" << endl;
	...
	cout << "tracking geometric model correction" << endl;

    mGeometry.GeometricModelCorrection(mCurrentFrame,mImGray,imMask);

	cout << "tracking frame update" << endl;
